...
def main():
    ...
    output = ScrolledText(frame, width=60, height=6, font=BOLD, fg="green", bg="lightgray", border="10", state="disabled", relief="flat")
    ...
    input_box = ScrolledText(frame, width=60, height=3, font="BOLD")
